Η εφαρμογή αυτή αναπαριστά το app ενος restaurant όπου ο χρήστης μπορεί να δεί το μενου, να χρησιμοποιήσει διάφορα φίλτρα, να δεί το κάθε πιάτο ξεχωριστά και να παραγγείλει.
